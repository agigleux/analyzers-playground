...
public class Day20_Ornaments_UserController extends HttpServlet {
  ...
  /**
   * Current attributes of objectClass "simpleSecurityObject": createtimestamp,
   * creatorsname, dn, entrycsn, entrydn, entryuuid, objectclass, userpassword,
   * uuid
   */
  ...
  private static boolean userExists(DirContext ctx, String username) throws Exception {
    String[] security_blacklist = { "uuid", "userpassword", "surname", "mail", "givenName", "name", "cn", "sn",
        "objectclass", "|", "&" };
