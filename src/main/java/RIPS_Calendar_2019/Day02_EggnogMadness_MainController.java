...
// "rawJson" is said to be user-controlled but actually it's not the case
public class Day02_EggnogMadness_MainController {
    ...
    public Day02_EggnogMadness_MainController(String rawJson) {
        this(parseJsonAsString(rawJson, "controller"), parseJsonAsString(rawJson, "task"), parseJsonAsArray(rawJson, "data"));
    }

    private Day02_EggnogMadness_MainController(String controllerName, String task, String... data){
        try {
